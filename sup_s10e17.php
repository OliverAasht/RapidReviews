...
<?php
 //error_reporting(E_ALL); ini_set('display_errors', 'On'); 
    ...
    $query = "SELECT * FROM rr_critic_review WHERE REVIEW_ID = '22'";
    ...
    <div class="tab-top-border"></div>
     ...
     <?php
       ...
       <div class="four columns">
        ...
        <p><strong>Directed by:</strong> Rashaad Ernesto Green</p>
        <p><strong>Written by:</strong> Andrew Dabb </p>
        </div>
...
<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://oliveraasht.co.uk/Rapid_Reviews/sup_s10e17.php" data-text="Supernatural: S10 E17 - &quot;Inside Man&quot;" data-via="Rapid_ReviewsUK">Tweet</a>
...
<p>
        ...
        <p style="width: 600px; font-size: 17px; line-height: 1.5;"><strong>Review: </strong><?php echo $rev_text;?></p>
                            ...
                            <p style="padding-left: 100px;">
                              <iframe height="250" width="400" src="https://www.youtube.com/embed/rITLTWJqI0g" frameborder="0" allowfullscreen></iframe>
...
<h3>Review this TV Show</h3>
    ...
    <div class="rating">
        ...
        echo '<form id="user_review" method ="post" action ="sup_s10e17.php">';
...
<script type="text/javascript">
    ...
    var disqus_shortname = 'rrsups10e17';

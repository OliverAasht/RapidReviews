...
<?php
 //error_reporting(E_ALL); ini_set('display_errors', 'On'); 
    ...
    $query = "SELECT * FROM rr_critic_review WHERE REVIEW_ID = '12'";
    ...
    <div class="tab-top-border"></div>
     ...
     <?php
       ...
       <div class="four columns">
        ...
        <p><strong>Developed by:</strong> Greg Berlanti, Marc Guggenheim & Andrew Kreisberg</p>
        <p>Based on characters appearing in DC Comics</p>
        </div>
...
<p>
<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://oliveraasht.co.uk/Rapid_Reviews/arrow_s03e17.php" data-text="Arrow: S03E17 - &quot;Suicidal Tendencies&quot;" data-via="Rapid_ReviewsUK">Tweet</a>
...
<iframe height="250" width="400" src="https://www.youtube.com/embed/fptVxQEPq4g" frameborder="0" allowfullscreen></iframe>
...
<h3>Review this TV Show</h3>
    ...
    <div class="rating">
        ...
        echo '<form id="user_review" method ="post" action ="arrow_s03e17.php">';
...
<script type="text/javascript">
    ...
    var disqus_shortname = 'rrarrows03e17';

...
<?php
 //error_reporting(E_ALL); ini_set('display_errors', 'On'); 
    ...
    $query = "SELECT * FROM rr_critic_review WHERE REVIEW_ID = '40'";
...
<p>
<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://oliveraasht.co.uk/Rapid_Reviews/flash_s01.php" data-text="The Flash: Season 1" data-via="Rapid_ReviewsUK">Tweet</a>
...
<iframe height="250" width="400" src="https://www.youtube.com/embed/KxnMK90wjFg" frameborder="0" allowfullscreen></iframe>
...
<script type="text/javascript">
    ...
    var disqus_shortname = 'rrflashs01';

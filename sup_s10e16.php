...
<?php
 //error_reporting(E_ALL); ini_set('display_errors', 'On'); 
    ...
    $query = "SELECT * FROM rr_critic_review WHERE REVIEW_ID = '21'";
    ...
    <div class="tab-top-border"></div>
     ...
     <?php
       ...
       <div class="four columns">
        ...
        <p><strong>Directed by:</strong> John Showalter</p>
        <p><strong>Written by:</strong> Brad Bucker & Eugenie Ross-Leming </p>
        </div>
...
<p>
  <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://oliveraasht.co.uk/Rapid_Reviews/sup_s10e16.php" data-text="Supernatural: S10 E16 - &quot;Paint it Black&quot;" data-via="Rapid_ReviewsUK">Tweet</a>
...
<iframe width="400" height="250" src="https://www.youtube.com/embed/O65KG45LKho" frameborder="0" allowfullscreen></iframe>
               ...
               if ($_SESSION['chng_tab'] == '1')
                {
                    ...
                    /*The following code was ammended from: stackoverflow.com/questions/8118266/integrating-css-star-rating-into-an-html-form
Stackoverflow is a website for developers to post problems concering code. These issues are then solved by other users*/
.rating {
   /* float:left;*/
    width:300px;
}
...
<h3>Review this TV Show</h3>
    ...
    <div class="rating">
        ...
        echo '<form id="user_review" method ="post" action ="sup_s10e16.php">';
...
<h3>More  Supernatural</h3>
<?php
   $query_sn = "SELECT * FROM  rr_critic_review WHERE TITLE LIKE  \"%Supernatural%\"";


    $sn_res = mysqli_query($connection, $query_sn) or exit("Error in query: " . $query_sn . mysqli_error());

     while ($sn_row = mysqli_fetch_assoc($sn_res)) {


        echo '<a style="color: black;" href="'. $sn_row['PAGE_NAME']. '"> '. $sn_row['TITLE']. '</a>';
        echo '<br>';
             }
...
<script type="text/javascript">
    ...
    var disqus_shortname = 'rrsups10e16';
...
/*The above code was ammended from: stackoverflow.com/questions/8118266/integrating-css-star-rating-into-an-html-form
Stackoverflow is a website for developers to post problems concering code. These issues are then solved by other users*/

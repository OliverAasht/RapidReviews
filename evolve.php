...
<?php
 //error_reporting(E_ALL); ini_set('display_errors', 'On'); 
    ...
    $query = "SELECT * FROM rr_critic_review WHERE REVIEW_ID = '29'";
    ...
    <div class="tab-top-border"></div>
     ...
     <?php
       ...
       <div class="four columns">
        ...
        <p><strong>Publisher:</strong> 2K Games</p>
        <p><strong>Developer:</strong> Turtle Rock Studios</p>
        </div>
...
<p>
  <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://oliveraasht.co.uk/Rapid_Reviews/evolve.php" data-text="EVOLVE" data-via="Rapid_ReviewsUK">Tweet</a>
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
        ...
        <p style="width: 600px; font-size: 17px; line-height: 1.5;"><strong>Review: </strong><?php echo $rev_text;?></p>
                            ...
                            <p style="padding-left: 100px;">
                              <iframe height="250" width="400" src="https://www.youtube.com/embed/63BJB9bECB0" frameborder="0" allowfullscreen></iframe>
...
<h3>Review this TV Show</h3>
    ...
    <div class="rating">
        ...
        echo '<form id="user_review" method ="post" action ="evolve.php">';

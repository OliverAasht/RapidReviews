...
<?php
 //error_reporting(E_ALL); ini_set('display_errors', 'On'); 
    ...
    $query = "SELECT * FROM rr_critic_review WHERE REVIEW_ID = '18'";
...
<p>
  <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://oliveraasht.co.uk/Rapid_Reviews/coak_s01e02.php" data-text="Code of a killer S01E02" data-via="Rapid_ReviewsUK">Tweet</a>
...
<script type="text/javascript">
    ...
    var disqus_shortname = 'rrcoaks01e02';

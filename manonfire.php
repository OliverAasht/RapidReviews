...
<?php
 //error_reporting(E_ALL); ini_set('display_errors', 'On'); 
    ...
    $query = "SELECT * FROM rr_critic_review WHERE REVIEW_ID = '6'";
    ...
    <div class="tab-top-border"></div>
     ...
     <?php
       ...
       <div class="four columns">
        ...
        <p><strong>Screenplay by:</strong> Brian Helgeland</p>
        </div>
...
<p>
 <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://oliveraasht.co.uk/Rapid_Reviews/manonfire.php" data-text="Man On Fire (2004)" data-via="Rapid_ReviewsUK">Tweet</a>
...
<iframe height="250" width="400" src="https://www.youtube.com/embed/g4kLizDXLY0" frameborder="0" allowfullscreen></iframe>
...
<h3>Review this TV Show</h3>
    ...
    <div class="rating">
        ...
        echo '<form id="user_review" method ="post" action ="manonfire.php">';
...
<script type="text/javascript">
    ...
    var disqus_shortname = 'rrmanonfire';

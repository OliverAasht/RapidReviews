...
<?php
 //error_reporting(E_ALL); ini_set('display_errors', 'On'); 
    ...
    $query = "SELECT * FROM rr_critic_review WHERE REVIEW_ID = '36'";
    ...
    <div class="tab-top-border"></div>
     ...
     <?php
       ...
       <div class="four columns">
        ...
        <p><strong>Directed by:</strong>  Anthony Russo & Joe Russon</p>
        <p><strong>Screenplay by:</strong> Christopher Markus & Stephen McFeely</p>
        </div>
...
<p>
 <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://oliveraasht.co.uk/Rapid_Reviews/cap_ws.php" data-text="Captain America:The Winter Soldier (2014)" data-via="Rapid_ReviewsUK">Tweet</a>
...
<iframe height="250" width="400" src="https://www.youtube.com/embed/NLWsK1ZFunA" frameborder="0" allowfullscreen></iframe>

...
<?php
 //error_reporting(E_ALL); ini_set('display_errors', 'On'); 
    ...
    $query = "SELECT * FROM rr_critic_review WHERE REVIEW_ID = '41'";
...
<p>
<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://oliveraasht.co.uk/Rapid_Reviews/rgs_s01.php" data-text="The Ricky Gervais Show - Season 1" data-via="Rapid_ReviewsUK">Tweet</a>
...
<script type="text/javascript">
    ...
    var disqus_shortname = 'rrrickygervaisshow01';

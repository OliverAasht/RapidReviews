...
body{
  ...
  #content
  {
    ...
    $query = "SELECT * FROM rr_critic_review WHERE CATEGORY = 'TV Show'";
    ...
    print "<th>Box Art</th><th><a style=\"color: #e50914;\" href=\"tvshows.php?TITLE=TITLE ASC\">Title</a></th><th><a style=\"color: #e50914;\" href=\"tvshows.php?REVIEW_DATE=REVIEW_DATE DESC\">Review Date</a></th><th><a style=\"color: #e50914;\" href=\"tvshows.php?RATING=RATING DESC\">Rating</a></th>";

...
<?php
 //error_reporting(E_ALL); ini_set('display_errors', 'On'); 
    ...
    $query = "SELECT * FROM rr_critic_review WHERE REVIEW_ID = '10'";
...
<p>
<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://oliveraasht.co.uk/Rapid_Reviews/arrow_s03e15.php" data-text="Arrow: S03E15 - &quot;Nanda Parbat&quot;" data-via="Rapid_ReviewsUK">Tweet</a>
...
<h3>Review this TV Show</h3>
    ...
    <div class="rating">
        ...
        echo '<form id="user_review" method ="post" action ="arrow_s03e15.php">';
...
<script type="text/javascript">
    ...
    var disqus_shortname = 'rrarrows03e15';

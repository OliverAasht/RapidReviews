...
<?php
 //error_reporting(E_ALL); ini_set('display_errors', 'On'); 
    ...
    $query = "SELECT * FROM rr_critic_review WHERE REVIEW_ID = '38'";
    ...
    <div class="tab-top-border"></div>
     ...
     <?php
       ...
       <div class="four columns">
        ...
        <p><strong>Showrunner:</strong> Steven S. DeKnight</p>
        <p><strong>Created by:</strong> Drew Goddard</p>
        </div>
...
<p>
<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://oliveraasht.co.uk/Rapid_Reviews/dd.php" data-text="Daredevil: Season 1" data-via="Rapid_ReviewsUK">Tweet</a>
...
<iframe height="250" width="400" src="https://www.youtube.com/embed/muPnTMqJZSM" frameborder="0" allowfullscreen></iframe>
...
<script type="text/javascript">
    ...
    var disqus_shortname = 'rrdaredevil';

...
<?php
 //error_reporting(E_ALL); ini_set('display_errors', 'On'); 
    ...
    $query = "SELECT * FROM rr_critic_review WHERE REVIEW_ID = '19'";
    ...
    <div class="tab-top-border"></div>
     ...
     <?php
       ...
       <div class="four columns">
        ...
        <p><strong>Directed by:</strong> Phil Sgriccia</p>
        <p><strong>Written by:</strong> Robert Berensr</p>
        </div>
...
<p>
<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://oliveraasht.co.uk/Rapid_Reviews/sup_s10e14.php" data-text="Supernatural: S10 E14 - &quot;The Executioner's Song&quot;" data-via="Rapid_ReviewsUK">Tweet</a>
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
        ...
        <p style="width: 600px; font-size: 17px; line-height: 1.5;"><strong>Review: </strong><?php echo $rev_text;?></p>
                            ...
                            <p style="padding-left: 100px;">
                              <iframe width="400" height="250" src="https://www.youtube.com/embed/SJghD4mM_Yc" frameborder="0" allowfullscreen></iframe>
...
<h3>Review this TV Show</h3>
    ...
    <div class="rating">
        ...
        echo '<form id="user_review" method ="post" action ="sup_s10e14.php">';
...
<script type="text/javascript">
    ...
    var disqus_shortname = 'sups10e14';

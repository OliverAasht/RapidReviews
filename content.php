...
<p>
<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://oliveraasht.co.uk/Rapid_Reviews/index.php" data-text="Testing testing 123" data-via="RapidReviews">Tweet</a>
...
<h3>Review this TV Show</h3>
    ...
    <div class="rating">
        ...
        echo '<textarea style="width: 610px; height: 150px;" placeholder=\'Please type your review in here\' name="desc" maxlength="1000"></textarea>';
        echo '<br>';
...
</div><!---END of two thirds column------>
  <div style="width: 300px; padding-left: 625px;">
            <?php
...
<script type="text/javascript">
    ...
    var disqus_shortname = 'httpoliveraashtcoukrapidreviews';

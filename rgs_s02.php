...
<?php
 //error_reporting(E_ALL); ini_set('display_errors', 'On'); 
    ...
    $query = "SELECT * FROM rr_critic_review WHERE REVIEW_ID = '42'";
    ...
    <div class="tab-top-border"></div>
     ...
     <?php
       ...
       <div class="four columns">
        ...
        <p><strong>Hosted by:</strong> Ricky Gervais, Stephen Merchant & Karl Pilkington</p>
        <p><strong>Created by:</strong> Ricky Gervais, Stephen Merchant & Karl Pilkington </p>
        </div>
...
<p>
<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://oliveraasht.co.uk/Rapid_Reviews/rgs_s02.php" data-text="The Ricky Gervais Show - Season 2" data-via="Rapid_ReviewsUK">Tweet</a>
...
<script type="text/javascript">
    ...
    var disqus_shortname = 'rrrickygervaisshows02';

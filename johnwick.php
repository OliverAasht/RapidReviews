...
<?php
 //error_reporting(E_ALL); ini_set('display_errors', 'On'); 
    ...
    $query = "SELECT * FROM rr_critic_review WHERE REVIEW_ID = '8'";
    ...
    <div class="tab-top-border"></div>
     ...
     <?php
       ...
       <div class="four columns">
        ...
        <p><strong>Directed by:</strong>  Chad Stahelski & David Leitch (uncredited)</p>
        <p><strong>Written by:</strong> Derek Kolstad</p>
        </div>
...
<p>
<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://oliveraasht.co.uk/Rapid_Reviews/johnwick.php" data-text="John Wick (2014)" data-via="Rapid_ReviewsUK">Tweet</a>
...
<iframe height="250" width="400" src="https://www.youtube.com/embed/C0BMx-qxsP4" frameborder="0" allowfullscreen></iframe>
...
<h3>Review this TV Show</h3>
    ...
    <div class="rating">
        ...
        echo '<form id="user_review" method ="post" action ="johnwick.php">';
...
<script type="text/javascript">
    ...
    var disqus_shortname = 'rrjohnwick';
...
/*The above code block was ammended from: stackoverflow.com/questions/8118266/integrating-css-star-rating-into-an-html-form
Stackoverflow is a website for developers to post problems concering code. These issues are then solved by other users*/

...
<?php
 //error_reporting(E_ALL); ini_set('display_errors', 'On'); 
    ...
    $query = "SELECT * FROM rr_critic_review WHERE REVIEW_ID = '45'";
    ...
    <div class="tab-top-border"></div>
     ...
     <?php
       ...
       <div class="four columns">
        ...
        <p><strong>Developed by:</strong> James Manos, Jr.</p>
        <p>Based on the novel "Darkly Dreaming Dexter" by Jeff Lindsay</p>
        </div>
...
<p>
<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://oliveraasht.co.uk/Rapid_Reviews/dexter_s03.php" data-text="Dexter: Season 3" data-via="Rapid_ReviewsUK">Tweet</a>
...
<iframe height="250" width="400" src="https://www.youtube.com/embed/T8bB6-BesqA" frameborder="0" allowfullscreen></iframe>
...
<script type="text/javascript">
    ...
    var disqus_shortname = 'rrdexters03';

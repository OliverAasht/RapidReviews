...
body{
  ...
  #content
  {
    ...
    $query = "SELECT * FROM rr_critic_review WHERE CATEGORY = 'Game'";
    ...
    print "<th>Box Art</th><th><a style=\"color: #e50914;\" href=\"games.php?TITLE=TITLE ASC\">Title</a></th><th><a style=\"color: #e50914;\" href=\"games.php?REVIEW_DATE=REVIEW_DATE DESC\">Review Date</a></th><th><a style=\"color: #e50914;\" href=\"games.php?RATING=RATING DESC\">Rating</a></th>";

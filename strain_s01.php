...
<?php
 //error_reporting(E_ALL); ini_set('display_errors', 'On'); 
    ...
    $query = "SELECT * FROM rr_critic_review WHERE REVIEW_ID = '47'";
    ...
    <div class="tab-top-border"></div>
     ...
     <?php
       ...
       <div class="four columns">
        ...
        <p><strong>Created by:</strong> Guillermo del Toro & Chuck Hogan</p>
        <p>Based on the novel "The Strain" by Guillermo del Toro & Chuck Hogan</p>
...
<p>
<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://oliveraasht.co.uk/Rapid_Reviews/strain_s01.php" data-text="The Strain: Season 01" data-via="Rapid_ReviewsUK">Tweet</a>
...
<iframe height="250" width="400" src="https://www.youtube.com/embed/DqcuyXeN8O8" frameborder="0" allowfullscreen></iframe>
...
<script type="text/javascript">
    ...
    var disqus_shortname = 'rrstrains01';

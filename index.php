...
<div id="content"><!-- Content START-->
	...
	<!-- Caption Style -->
    <!---The following CSS code labelled "CSS1" was ammended from http://www.jssor.com/index.html. A website which provides pre-built banner sliders using JaveScript and HTML---->
    <style> /*CSS1*/
    ...
    <!---The following script files and code was copied from http://www.jssor.com/index.html. A website which provides pre-built banner sliders using JaveScript and HTML---->
  ...
  <!---The following code block which begins with the comment "Jssor slider begin" and ends with the comment "Jssor slider end" was ammended from http://www.jssor.com/index.html. A website which provides pre-built banner sliders using JaveScript and HTML---->
    ...
    <div id="slider1_container" style="position: relative; width: 600px;
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 600px; height: 300px;
            overflow: hidden;">
            <div>
                <a u=image href="http://oliveraasht.co.uk/Rapid_Reviews/dd.php"><img src="assets/images/dd_banner.jpg" /></a>
                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                <a style="color: white;" href="http://oliveraasht.co.uk/Rapid_Reviews/dd.php">Read the Daredevil Review</a>
                </div>
            </div>
            <div>
                <a u=image href="http://oliveraasht.co.uk/Rapid_Reviews/fast7.php"><img src="assets/images/furious7_banner.jpg" /></a>
                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                <a style="color: white;" href="http://oliveraasht.co.uk/Rapid_Reviews/fast7.php">Is Furious 7 worth a watch?</a>
                </div>
            </div>
            <div>
                <a u=image href="http://oliveraasht.co.uk/Rapid_Reviews/evolve.php"><img src="assets/images/evolve_banner.jpg" /></a>
                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                <a style="color: white;" href="http://oliveraasht.co.uk/Rapid_Reviews/evolve.php">Is Evolve worth playing?</a>
                </div>
            </div>
		...
		<div class="one-third column"><!--------------1/3 START---------->
			...
			<h4>Straped for time and want to read reviews that get to the point?</h4>
			<br>
			<h4>Want to find out how good something is without reading spoilers?</h4>
			<br>
			<h4>Well you've come to the right place!</h4>
...
<div class="sixteen columns" >
		...
		<div class="one-third column"><!-- (2nd) 1/3s START-->
			<?php
		...
		<div class="one-third column"><!-- (3rd) 1/3s START-->
			<?php
		...
		<div class="five columns"><!-- 5 col START-->
			<?php
